...
<%--								<button type="button" id="btn-write" class="btn btn-block btn-default">글쓰기</button>--%>

<%--								<div class="input-group input-group-sm">--%>
<%--								<form id="search-form" name="search-form">--%>
<%--									<input type="hidden" name="typeIdNo" value="2"/>--%>
 					...
 					<div class="card-header">
						<div class="card-tools">
							<ul class="pagination pagination-sm float-right">
								<!-- first page-->
								<li class="page-item"><a class="page-link" href="unknown?pageNo=1">«</a><li>
								<!-- previous page -->
								<c:choose>
									...
									<c:otherwise>
										<li class="page-item"><a class="page-link" href="unknown?pageNo=${pageNo - 1}">이전</a><li>
									</c:otherwise>
								</c:choose>
								<span id="pager-span">
								${pager}
								...
								<c:choose>
									...
									<c:otherwise>
										<li class="page-item"><a class="page-link" href="unknown?pageNo=${pageNo + 1}">다음</a><li>
									</c:otherwise>
								</c:choose>
								<!-- last page -->
								<li class="page-item"><a class="page-link" href="unknown?pageNo=${pageCount}">»</a><li>
							</ul>
						</div>
					</div>
					<!-- card pagination -->
