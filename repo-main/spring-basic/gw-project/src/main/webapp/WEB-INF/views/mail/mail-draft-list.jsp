					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">임시보관함</li>
							</ol>
						</div>
					</div>
				</div>
									...
									<div class="mailbox-controls">
										...
										<div class="btn-group">
											...
											<a type="button" class="btn btn-default btn-sm"
												href='mail-draft-list.action?pageNo=1'> <i
												class="fas fa-reply"></i></a> <a type="button"
												class="btn btn-default btn-sm"
												href='mail-draft-list.action?pageNo=${ pageCount }'> <i
												class="fas fa-share"></i></a>
										</div>
										<!-- /.btn-group -->
										<a type="button" class="btn btn-default btn-sm"
											href='mail-draft-list.action'><i class="fas fa-sync-alt"></i> </a>
										<div class="float-right">
											${ mailCount }
											<div class="btn-group">
												<a type="button" class="btn btn-default btn-sm"
													href='mail-draft-list.action?pageNo=${ pageBefore }'> <i
													class="fas fa-chevron-left"></i>
												</a> <a type="button" class="btn btn-default btn-sm"
													href='mail-draft-list.action?pageNo=${ pageNext }'> <i
												...
												<c:forEach var="mail" items="${ mails }">
														<tr class='mail-tr' data-mail-no='${mail.mailNo}'
															...
															<td style="text-align: left; padding-left: 5px;"><a
																href='mail-all-detail.action?mailNo=${ mail.mailNo }&pageNo=${ pageNo }'>
																	${ mail.title } </a></td>
		...
		$(function() {
			...
			$('.mail-tr').on(
					...
					function(event) {
						...
						location.href = 'mail-all-detail.action?mailNo='+ mailNo + '&pageNo=' + ${pageNo};
					});
		})
	</script>
</body>
