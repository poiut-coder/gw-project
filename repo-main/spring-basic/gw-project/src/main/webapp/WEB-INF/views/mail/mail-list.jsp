									...
									<div class="mailbox-controls">
										...
										<div class="btn-group">
											...
											<a type="button" class="btn btn-default btn-sm"
												href='mail-list.action?pageNo=1'> <i
												class="fas fa-reply"></i></a> <a type="button"
												class="btn btn-default btn-sm"
												href='mail-list.action?pageNo=${ pageCount }'> <i
												class="fas fa-share"></i></a>
										</div>
										<!-- /.btn-group -->
										<a type="button" class="btn btn-default btn-sm"
											href='mail-list.action'><i class="fas fa-sync-alt"></i> </a>
										<div class="float-right">
											${ mailCount }
											<div class="btn-group">
												<a type="button" class="btn btn-default btn-sm"
													href='mail-list.action?pageNo=${ pageBefore }'> <i
													class="fas fa-chevron-left"></i>
												</a> <a type="button" class="btn btn-default btn-sm"
													href='mail-list.action?pageNo=${ pageNext }'> <i
