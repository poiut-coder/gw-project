									...
									<div class="card-tools">
										<div class="input-group input-group-sm">
											<div class="input-group-append">
												<form action="send-list-search.action" method="post">
													<label>Search: ${search}
									...
									<div class="memobox-controls">
										...
										<div class="btn-group">
											...
											<a type="button" class="btn btn-default btn-sm"
												href='memo-send-list.action?pageNo=1'> <i
												class="fas fa-reply"></i></a> <a type="button"
												class="btn btn-default btn-sm"
												href='memo-send-list.action?pageNo=${ pageCount }'> <i
												class="fas fa-share"></i></a>
										</div>
										<!-- /.btn-group -->
										<a type="button" class="btn btn-default btn-sm"
											href='memo-send-list.action'><i class="fas fa-sync-alt"></i> </a>
										<div class="float-right">
											${ memoCount }
											<div class="btn-group">
												<a type="button" class="btn btn-default btn-sm"
													href='memo-send-list.action?pageNo=${ pageBefore }'> <i
													class="fas fa-chevron-left"></i>
												</a> <a type="button" class="btn btn-default btn-sm"
													href='memo-send-list.action?pageNo=${ pageNext }'> <i
												...
												<c:forEach var="memo" items="${ memos }">
														<tr class='memo-tr' data-memo-no='${memo.m_id_no}'
															...
															<td style="text-align: left; padding-left: 5px;"><a
																href='memo-send-detail.action?m_id_no=${ memo.m_id_no }&pageNo=${ pageNo }'>
																	${ memo.m_content } </a></td>
		...
		$(function() {
			...
			$('.memo-tr').on(
					...
					function(event) {
						...
						location.href = 'memo-send-detail.action?m_id_no='+ m_id_no + '&pageNo=' + ${pageNo};
					});
		})
	</script>
</body>
